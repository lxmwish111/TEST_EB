...
#include <SchM_Com.h>    /* generated SchM/Com configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_Com
(
  uint8 ExclusiveArea
)
{
    ...
    switch (ExclusiveArea)
    {
      ...
      case SCHM_COM_EXCLUSIVE_AREA_0:
      ...
      case SCHM_COM_EXCLUSIVE_AREA_1:
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_Com
(
  uint8 ExclusiveArea
)
{
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_Com
(
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_Com
(
  uint8 ActivationPoint
)
{
