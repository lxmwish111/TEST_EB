...
#include <SchM_CanIf.h>    /* generated SchM/CanIf configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_CanIf
(
  uint8 ExclusiveArea
)
{
    ...
    switch (ExclusiveArea)
    {
      ...
      case SCHM_CANIF_EXCLUSIVE_AREA_0:
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_CanIf
(
  uint8 ExclusiveArea
)
{
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_CanIf
(
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_CanIf
(
  uint8 ActivationPoint
)
{
