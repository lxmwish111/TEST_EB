...
#include <SchM_Dio.h>    /* generated SchM/Dio configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_Dio
(
  uint8 InstanceId,
  uint8 ExclusiveArea
)
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_Dio
(
  uint8 InstanceId,
  uint8 ExclusiveArea
)
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_Dio
(
  uint8 InstanceId,
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_Dio
(
  uint8 InstanceId,
  uint8 ActivationPoint
)
