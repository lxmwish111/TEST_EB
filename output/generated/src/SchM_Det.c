...
#include <SchM_Det.h>    /* generated SchM/Det configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_Det
(
  uint8 ExclusiveArea
)
{
    ...
    switch (ExclusiveArea)
    {
      ...
      case SCHM_DET_EXCLUSIVE_AREA_0:
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_Det
(
  uint8 ExclusiveArea
)
{
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_Det
(
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_Det
(
  uint8 ActivationPoint
)
{
