...
#include <SchM_PduR.h>    /* generated SchM/PduR configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_PduR
(
  uint8 ExclusiveArea
)
{
    ...
    switch (ExclusiveArea)
    {
      ...
      case SCHM_PDUR_EXCLUSIVE_AREA_0:
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_PduR
(
  uint8 ExclusiveArea
)
{
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_PduR
(
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_PduR
(
  uint8 ActivationPoint
)
{
