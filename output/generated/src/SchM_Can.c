...
#include <SchM_Can.h>    /* generated SchM/Can configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_Can
(
  uint8 InstanceId,
  uint8 ExclusiveArea
)
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_Can
(
  uint8 InstanceId,
  uint8 ExclusiveArea
)
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_Can
(
  uint8 InstanceId,
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_Can
(
  uint8 InstanceId,
  uint8 ActivationPoint
)
