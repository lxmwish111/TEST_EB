...
#include <SchM_EcuM.h>    /* generated SchM/EcuM configuration */
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Enter_EcuM
(
  uint8 ExclusiveArea
)
{
    ...
    switch (ExclusiveArea)
    {
      ...
      case SCHM_ECUM_EXCLUSIVE_AREA_0:
 ...
 **
 **/
FUNC(void,SCHM_CODE) SchM_Exit_EcuM
(
  uint8 ExclusiveArea
)
{
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_ActMainFunction_EcuM
(
 ...
 **
 **/
FUNC(SchM_ReturnType, SCHM_CODE) SchM_CancelMainFunction_EcuM
(
  uint8 ActivationPoint
)
{
