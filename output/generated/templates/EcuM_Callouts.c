...
{
  /* insert your code here */
  /* If called in Sleep Sequence II the EcuM calls this callout functions
   * in a blocking loop at maximum frequency.The callout implementation must
   * ensure by other means, if callout code shall be executed with a lower period.
   * The integrator may choose any method to control this, e.g. with the help of
   * OS counters, OS alarms or Gpt timers.*/
}
