...
#################################################################
# CAN_WINSOCK_LIB_PATH:
# Path to the winsock lib necessary for compiling the WINDOWS Can
# driver. Usually set to the lib path of your compiler, for example
# $(TOOLPATH_COMPILER)\..\lib
#################################################################

CAN_WINSOCK_LIB_PATH ?= $(TOOLPATH_COMPILER)\..\lib
...
# In case you don't want to use the compiler provided with the base
# set the path to the mingw compiler here 
# e.g. C:\MinGw\bin
#################################################################
...
#
# disabled: option is enabled for ACG-5.x development
# CC_OPT += -pedantic
...
# disable warnings about unused values.
# This is activated for ACG-5.x
CC_OPT += -Wno-unused-value

# disable warnings about casts from pointer to integer of different size.
# This is activated for ACG-5.x.
CC_OPT += -Wno-pointer-to-int-cast
